...
public class SOMBenchMark1 {
	public static void main(String[] args){
		/*File f0 = new File("C://Users/Chris/Documents/!gb.seismic.binary");
		  File f1 = new File("C://Users/Chris/workspace/Harmonic_Attributes/sweep1.binary");
		  File f2 = new File("C://Users/Chris/workspace/Harmonic_Attributes/impulseat150.binary");
		  String pf0 = f0.getPath();
		  String pf1 = f1.getPath();
		  String pf2 = f2.getPath();

		 System.out.println(f2.getAbsolutePath());
		  UIOccurenceCounter ui = new UIOccurenceCounter(pf0);
		  float[][][] freqAmp = ui.getFreqs();*/
		...
		PointsView points = new PointsView(weight1,weight2);
		points.setMarkColor(java.awt.Color.RED);
		points.setMarkStyle(PointsView.Mark.CROSS);
		points.setMarkSize(4);
		points.setLineStyle(PointsView.Line.NONE);
		PlotPanel pp = new PlotPanel();
		pp.addTiledView(points);
