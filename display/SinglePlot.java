...
public class SinglePlot {
	...
	/**
	 * Plots 2D data with a y and x axis sampling.  The default color bar
	 * is white represents high values, while black represents low values.
	 * @param yaxis - Y axis uniform sampling
	 * @param xaxis - X axis uniform sampling
	 * @param data - 2D data. The first dimension: X - axis, 
	 * the second dimension: Y  - axis.
	 * @param percmin The lowest percentile that is displayed. 
	 * @param percmax The highest percentile that is displayed.
	 */
	public SinglePlot(Sampling yaxis, Sampling xaxis, float[][] data, float percmin, float percmax){
	...
	/**
	 * Plots 1D data with a y axis sampling. The default color bar
	 * is white represents high values, while black represents low values.
	 * @param yaxis - Y axis uniform sampling
	 * @param data - 1D data, the first dimension is the y axis.
	 */
	...
	/**
	 * Set the Title and Axis label and the overall font size. The title font will be 1.5 times 
	 * larger than the set font size.
	 * @param title String
	 * @param yaxis String
	 * @param xaxis String
	 */
	public void setTitleAndAxis(String title, String yaxis, String xaxis, float fontsize){
		pp.addTitle(title);
		pp.setVLabel(yaxis);
		pp.setHLabel(xaxis);
	 ...
	 * @param width the image width in inches.
